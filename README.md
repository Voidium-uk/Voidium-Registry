...
A small Node.js cache/proxy for reducing repeated npm registry traffic.
...
- Cached npm package files are stored compressed on disk and decompressed when served.
